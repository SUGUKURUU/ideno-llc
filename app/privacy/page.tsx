    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-3xl mx-auto px-6 py-24">
        ...
        <div className="space-y-10 text-white/60 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-4">4. 第三者への提供</h2>
            <p>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-4">5. お問い合わせ</h2>
            <p>
              個人情報に関するお問い合わせは、下記までご連絡ください。
              <br />
              合同会社出野 担当窓口：info@ideno-llc.jp
            </p>
          </section>
        </div>
      </div>
