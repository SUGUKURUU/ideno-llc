...
// TODO: 代表者・お問い合わせ窓口など確定情報に差し替える
const sections = [
  {
    title: "1. 基本方針",
    body: "compath株式会社（以下「当社」）は、人材紹介事業および貨物軽自動車運送事業の業務委託の取扱いにおいて、お客様・求職者・業務委託パートナーの個人情報を適切に管理し、個人情報の保護に関する法令を遵守します。",
  },
  {
    title: "2. 取得する情報",
